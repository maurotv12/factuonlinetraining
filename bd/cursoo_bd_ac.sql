...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2025 a las 18:25:16
...
(24, 'flutter-movil-de-cero-a-experto-en-5-horas', 'Flutter - Móvil: De cero a experto en 5 horas', 'Este curso representa años de esfuerzo y estudio en Dart y Flutter sintetizados en más de 50 horas de video bajo demanda que van desde las bases del lenguaje Dart, hasta todo lo necesario para crear aplicaciones en Flutter funcionales y atractivas visualmente.\r\n\r\nEl curso no sólo pretende enseñarte Dart y Flutter, sino que aprendas a crear aplicaciones reales siguiendo el Doman Driven Design, una forma de programar y estructurar proyectos que nos permitan hacer aplicaciones fáciles de expandir y mantener, pasando por Clean Code y varios patrones que te ayudarán a que estés orgulloso del código que escribes.\r\n\r\nPuntualmente veremos:\r\n\r\nBases de Dart\r\n\r\nDesde Hola Mundo hasta funciones generadoras\r\n\r\nPasando por clases abstractas, mixins hasta su uso en patrones arquitectónicos\r\n\r\nStateless y Stateful Widgets\r\n\r\nHojas de Atajos para acompañarte\r\n\r\nCientos de widgets de Flutter\r\n\r\nWidgets personalizados\r\n\r\nGestores de estados\r\n\r\nRiverpod 2.3 >\r\n\r\nFutter_Bloc 8>\r\n\r\nProvider 6 >\r\n\r\nCubits\r\n\r\nState en Stateful Widgets', 'prender Dart para utilizarlo cómodamente en Flutter \r\nDominar Flutter mediante muchas aplicaciones funcionales y visualmente atractivas \r\nGestionar la estructura de proyectos de Flutter\r\nAplicar principios SOLID, Clean Code y bases de arquitecturas de software \r\nPublicar Aplicaciones en la Apple AppStore y Google PlayStore ', 'Es necesario tener conceptos de programación estructurada \r\nSi no se sabe el requisito anterior, es recomendado mi curso de\r\nPuedes seguir el curso en Windows, Mac o Linux (Instalaciones \r\nRevisar los requisitos mínimos de Flutter dependiendo de tu sistema ', 'Cualquier persona que quiera aprender Flutter\nCualquiera que quiera mejorar en Dart\nCualquiera que quiera aprender a crear hermosas\nTodos los que quieran aprender a manejar un Router auto\nPersonas que quieran mantenerse actualizados en la tecnolog', 'storage/public/banners/68d5707aba951_1758818426.jpg', 'storage/public/promoVideos/68d5707abaccd_1758818426.mp4', 65000, 4, 16, 'activo', '2025-09-25 16:40:27'),
(27, 'rob-tica-industrial-programaci-n-y-control-de-robots', 'Robótica Industrial: Programación y Control de Robots', 'Conoce el funcionamiento de un robot industrial, identifica los parámetros clave a configurar en un robot y utiliza los conocimientos adquiridos para implementar distintas aplicaciones industriales.\r\n\r\n\r\n\r\nAl día de hoy no existe una normalización para la programación de robots industriales, cada fabricante tiene su propio lenguaje de programación, el cual es válido solo para sus propios equipos.\r\n\r\nPero la metodología utilizada para cada uno de ellos es la misma, durante el curso estaremos revisando que los conceptos y prácticas que realicemos, se podrán aplicar en robots de distintas marcas.\r\n\r\nEsto lo vamos a comprobar utilizando el Software RoboDK, que nos permitirá programar robots industriales de distintas marcas.\r\n\r\n\r\n\r\nDurante este entrenamiento estaremos implementando robots de distintas marcas en múltiples aplicaciones industriales.\r\n\r\nEstaremos enfocados en la implementación y la puesta en marcha de robots antropomórficos de 6 grados de libertad\r\n\r\n\r\n\r\nSe implementaran robots de marcas como ABB, FANUC, KUKA, Universal robots y mas., entre las distintas aplicaciones que se estarán realizando enlistamos las siguientes:\r\n\r\nImplementación de un robot ABB para una operación de Pick and place\r\n\r\nImplementación de un robot FANUC para una operación de atornillado\r\n\r\nImplementación de un robot KUKA para manipulación de pantallas LED\r\n\r\nImplementación de un robot UR10 para una operación de Machine Vending', 'Identificar los componentes de un robot industrial\r\nProgramación de Robots ABB\r\nProgramación de Robots KUKA\r\nProgramación de Robots FANUC\r\nProgramación de Robots Yaskawa\r\nProgramación de Robots Colaborativos\r\nimplementar robots de 6 grados de libertad en distintos procesos industriales\r\nConocer los componentes necesarios para automatizar un proceso industrial', 'El programa esta diseñado para iniciar desde 0, se recomienda contar con conocimientos básicos en programación y diseño asistido por computadora', 'Nuestro programa esta diseñado para estudiantes, técnicos e ingenieros que deseen profundizar un poco mas en la rama de la robótica industrial', 'storage/public/banners/68d6b89b1e5f8_1758902427.jpg', 'storage/public/promoVideos/68d6b89b1e902_1758902427.mp4', 90000, 3, 16, 'activo', '2025-09-26 16:00:27');
...
(54, 27, 'Sección 1: Iniciación al pensamiento algoritmico', 'Aprenderás a pensar de manera lógica para programación robotica', 1, 'activo', '2025-09-26 16:01:43', '2025-09-26 16:01:43');
...
(39, 24, 17, 'activo', 0, '2025-09-26 14:57:54');
...
(50, 16, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 09:01:19'),
(51, 16, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 09:08:58'),
(52, 16, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 09:09:07'),
(53, 17, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 09:09:17'),
(54, 16, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 09:21:44'),
(55, 17, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 09:33:19'),
(56, 17, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 09:36:57'),
(57, 17, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 09:45:24'),
(58, 17, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:11:43'),
(59, 16, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:14:12'),
(60, 17, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:19:42'),
(61, 16, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:22:49'),
(62, 17, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:24:44'),
(63, 16, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:30:36'),
(64, 15, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:30:46'),
(65, 13, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:30:59'),
(66, 17, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:31:21'),
(67, 16, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:31:33'),
(68, 13, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:32:09'),
(69, 16, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 10:33:52'),
(70, 13, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-26 11:10:45');
...
(17, 'clienteRegistro', 'Mauro Muñoz Sanchez', 'mauricioa.munoz@gmail.com', '$2y$10$w6CDUyfIBzUgTz3/j9t4Y.DvrPCZsOrel6tECuvLvkO4kPHH6kIri', 1, 'storage/public/usuarios/default.png', NULL, NULL, NULL, NULL, NULL, NULL, 'activo', 0, 0, 0, NULL, '2025-09-26 14:08:10');
...
(34, 22, 17, NULL, 'preinscrito', '2025-09-26 14:56:49', NULL),
(35, 27, 13, NULL, 'cancelado', '2025-09-26 16:16:02', '2025-09-26 16:16:05');
...
(62, 54, '1. Algoritmia Básica 1', '00:00:15', 1, 'activo', '2025-09-26 16:02:26', '2025-09-26 16:02:27'),
(63, 54, '2. Algoritmia intermedia', '00:00:58', 2, 'activo', '2025-09-26 16:04:36', '2025-09-26 16:04:37');
...
(131, 62, 'video', 'C:/xampp/htdocs/factuonlinetraining/storage/public/section_assets/27/54/62/video/68d6b912aa35b_1758902546.mp4', 'storage/public/section_assets/27/54/62/video/68d6b912aa35b_1758902546.mp4', 6966079, 15, '2025-09-26 16:02:26'),
(132, 63, 'pdf', 'C:/xampp/htdocs/factuonlinetraining/storage/public/section_assets/27/54/63/pdf/68d6b994a1f3e_1758902676.pdf', 'storage/public/section_assets/27/54/63/pdf/68d6b994a1f3e_1758902676.pdf', 220773, NULL, '2025-09-26 16:04:36'),
(133, 63, 'video', 'C:/xampp/htdocs/factuonlinetraining/storage/public/section_assets/27/54/63/video/68d6b9955c5d6_1758902677.mp4', 'storage/public/section_assets/27/54/63/video/68d6b9955c5d6_1758902677.mp4', 8146145, 58, '2025-09-26 16:04:37');
...
--
-- Volcado de datos para la tabla `seccion_contenido_progreso`
--

INSERT INTO `seccion_contenido_progreso` (`id`, `id_contenido`, `id_estudiante`, `visto`, `progreso_segundos`, `porcentaje`, `primera_vista`, `ultima_vista`) VALUES
(13, 57, 17, 1, 427, 100, '2025-09-26 10:05:45', '2025-09-26 15:07:22'),
(14, 58, 17, 1, 195, 100, '2025-09-26 10:06:17', '2025-09-26 15:06:39'),
(15, 59, 17, 1, NULL, 100, '2025-09-26 10:07:33', '2025-09-26 15:07:33'),
(16, 60, 17, 1, 649, 100, '2025-09-26 10:08:16', '2025-09-26 15:08:18'),
(17, 61, 17, 1, 64, 100, '2025-09-26 10:08:22', '2025-09-26 15:08:22'),
(18, 60, 16, 1, 641, 100, '2025-09-26 10:14:19', '2025-09-26 15:14:19'),
(19, 61, 16, 1, 65, 100, '2025-09-26 10:14:29', '2025-09-26 15:14:29'),
(20, 57, 16, 1, 429, 100, '2025-09-26 10:22:56', '2025-09-26 15:22:56'),
(21, 59, 16, 1, NULL, 100, '2025-09-26 10:23:01', '2025-09-26 15:23:01'),
(22, 58, 16, 1, 209, 100, '2025-09-26 10:23:15', '2025-09-26 15:23:15'),
(23, 63, 16, 1, 58, 100, '2025-09-26 11:05:51', '2025-09-26 16:09:01');
